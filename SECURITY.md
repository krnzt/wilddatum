...
EcoScope's security model assumes the local user trusts the installed native
...
they are not sandboxed plugins. EcoScope clears the child environment, sends no
