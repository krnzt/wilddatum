...
- Rerun SDK and Web Viewer — MIT OR Apache-2.0
- Model Context Protocol Rust SDK (`rmcp`) — MIT
- HDF5 — BSD-style HDF5 license
- `hdf5-metno` Rust bindings — MIT OR Apache-2.0
- `las` / `laz` — MIT
